...
pub const VT_ARRAY_I2: Tag = Tag(VT_ARRAY | 2);
pub const VT_ARRAY_I4: Tag = Tag(VT_ARRAY | 3);
pub const VT_ARRAY_R4: Tag = Tag(VT_ARRAY | 4);
pub const VT_ARRAY_R8: Tag = Tag(VT_ARRAY | 5);
pub const VT_ARRAY_CY: Tag = Tag(VT_ARRAY | 6);
pub const VT_ARRAY_DATE: Tag = Tag(VT_ARRAY | 7);
pub const VT_ARRAY_BSTR: Tag = Tag(VT_ARRAY | 8);
pub const VT_ARRAY_DISPATCH: Tag = Tag(VT_ARRAY | 9);
pub const VT_ARRAY_ERROR: Tag = Tag(VT_ARRAY | 10);
pub const VT_ARRAY_BOOL: Tag = Tag(VT_ARRAY | 11);
pub const VT_ARRAY_VARIANT: Tag = Tag(VT_ARRAY | 12);
pub const VT_ARRAY_UNKNOWN: Tag = Tag(VT_ARRAY | 13);
pub const VT_ARRAY_DECIMAL: Tag = Tag(VT_ARRAY | 14);
pub const VT_ARRAY_I1: Tag = Tag(VT_ARRAY | 16);
pub const VT_ARRAY_UI1: Tag = Tag(VT_ARRAY | 17);
pub const VT_ARRAY_UI2: Tag = Tag(VT_ARRAY | 18);
pub const VT_ARRAY_UI4: Tag = Tag(VT_ARRAY | 19);
pub const VT_ARRAY_INT: Tag = Tag(VT_ARRAY | 22);
pub const VT_ARRAY_UINT: Tag = Tag(VT_ARRAY | 23);
pub const VT_ARRAY_RECORD: Tag = Tag(VT_ARRAY | 36);
