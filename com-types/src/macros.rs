...
* [`com_ptr!`](../macro.com_ptr!.html)
  ...
  ```
  # #[macro_use] extern crate com_sys; #[macro_use] extern crate com_types; fn main() {
...
macro_rules! com_ptr {
	(
		...
		impl $crate::com::AsComPtr for $iface_ptr {
			type Interface = $iface;
			#[inline(always)] fn as_ptr(&self) -> *mut Self::Interface { self.0 }
		}
		impl $crate::com::ComPtr for $iface_ptr {
			#[inline(always)]
	...
	(
		...
		impl $crate::com::ComPtr for $iface_ptr {
			...
			unsafe fn new(iface: $crate::LPVOID) -> Self {
				debug_assert!(!iface.is_null());
				$iface_ptr(<$ibase_ptr as $crate::com::ComPtr>::new(iface))
			}
			#[inline(always)]
			unsafe fn from_ptr(iface: *mut $iface) -> Self {
		...
		impl $crate::com::ComCast<$ibase_ptr> for $iface_ptr {
...
macro_rules! com_call {
	($vfn:ident($this:expr $(,$args:expr)*)) => {{
		let this_ptr = $crate::com::AsComPtr::as_ptr($this);
